...
from AdvancedAI.StableDiffusion.model.vqvae import VQVAE
from AdvancedAI.StableDiffusion.model.lpips import LPIPS
from AdvancedAI.StableDiffusion.model.discriminator import Discriminator
from torch.utils.data.dataloader import DataLoader
from AdvancedAI.StableDiffusion.dataset.mnist_dataset import MnistDataset
from AdvancedAI.StableDiffusion.dataset.celeb_dataset import CelebDataset
from AdvancedAI.StableDiffusion.dataset.vehicle_dataset import VehicleDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', dest='config_path',
                        ...
                        # default='../config/celebhq.yaml',
                        default='../config/celebhq_text_image_cond.yaml',
                        #default='../config/mnist.yaml',pip3 install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu118
                        type=str)
