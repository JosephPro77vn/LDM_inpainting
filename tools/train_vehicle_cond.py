...
from AdvancedAI.StableDiffusion.model.unet_cond_based import Unet
from AdvancedAI.StableDiffusion.model.vqvae import VQVAE
from AdvancedAI.StableDiffusion.schedulers.linear_noise_scheduler import LinearNoiseScheduler
from AdvancedAI.StableDiffusion.utils.text_utils import *
from AdvancedAI.StableDiffusion.utils.config_utils import *
from AdvancedAI.StableDiffusion.utils.diffusion_utils import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', dest='config_path',
                        #default='../config/mnist_class_condition.yaml',
                        #default='../config/celebhq_text_cond_clip.yaml',
